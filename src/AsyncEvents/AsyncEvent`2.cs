...
namespace DeepgramSharp.AsyncEvents
{
    ...
    public sealed class AsyncEvent<TSender, TArgs>(string name, AsyncEventExceptionHandler<TSender, TArgs> exceptionHandler) : AsyncEvent(name)
        where TArgs : AsyncEventArgs
    {
        ...
        /// </summary>
        public void UnregisterAll() => _handlers = [];
